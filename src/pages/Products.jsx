...
const PRODUCT_DATA = [
  { 
    ...
    img: "https://images.unsplash.com/photo-1592833159057-6fd31899e900?auto=format&fit=crop&w=800&q=80", 
    best: true, 
  ...
  { 
    ...
    img: "https://images.unsplash.com/photo-1509391366360-fe5bef71c17f?auto=format&fit=crop&w=800&q=80", 
    best: false, 
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
          {PRODUCT_DATA.map((p, i) => (
            <GlassCard key={i} className="p-8 group hover:-translate-y-2">
              ...
              <button className="w-full bg-yellow-500 text-white py-4 rounded-2xl font-black shadow-lg hover:bg-yellow-600 transition-all">View Specs</button>
            </GlassCard>
          ))}
        </div>
      </div>
